      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-agri-gradient text-white px-6 py-2 rounded-lg font-medium hover:shadow-lg transition-all duration-300 hover:scale-105">
              Request Demo
            </button>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg border-t">
            <nav className="flex flex-col space-y-4 p-6">
              ...
              <button className="bg-agri-gradient text-white px-6 py-3 rounded-lg font-medium w-full">
                Request Demo
              </button>
            </nav>
          </div>
